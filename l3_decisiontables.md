# Decision Tables - SMART Guidelines Starter Kit v2.1.0
...
1. The output of the decision table should be one of the approved logical data objects that are part of the "artifacts catalog".
* a. If an L3 author needs a new data object, the necessary logical model and profile should also be created or reused.

1. For each Action in the decision table output:
...
[SMART Guidelines - Immunizations (Measles): PlanDefinitions](https://worldhealthorganization.github.io/smart-example-immz/artifacts.html#knowledge-artifacts-plan-definitions) [SMART Guidelines - Immunizations (Measles): Activity Definitions](https://worldhealthorganization.github.io/smart-example-immz/artifacts.html#knowledge-artifacts-activity-definitions)
