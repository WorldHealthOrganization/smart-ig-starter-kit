---
id: l3/author-forms
name: Author questionnaires
description: Turn logical models into SDC Questionnaires with the two-step structure map extraction pattern.
expert: l3-ig-expert
...
sop: input/pagecontent/l3_forms.md
status: placeholder
---

### Procedure

The procedure is [Forms](../../../../input/pagecontent/l3_forms.md), and that page is the single source of truth for it.
