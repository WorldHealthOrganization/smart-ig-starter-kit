...
id: l3/author-cql
name: Author CQL
description: Write the concept, element, decision, indicator and scheduling CQL libraries, using the documented comment tag conventions.
expert: l3-ig-expert
...
sop: input/pagecontent/l3_cql.md
status: placeholder
---

### Procedure

The procedure is [CQL](../../../../input/pagecontent/l3_cql.md), and that page is the single source of truth for it.
