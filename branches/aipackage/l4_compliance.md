# L4 Compliance - SMART Guidelines Starter Kit v2.1.0
...
**How it is used by digital health tools:** L1 serves as the foundational reference for public health practitioners and policymakers, informing the design and implementation of digital health tools. These digital health tools align with L1 to ensure evidence-based decision-making.
...
**How it is used by digital health tools:** L2 provides structured implementation guidance (**Product Requirement Document**) to software developers and system designers, enabling them to configure digital health applications leveraging WHO recommendations. It acts as a **software-agnostic bridge** between health policies and digital implementation/tools.
...
**How it is used by digital health tools:** L3 provides **computable logic** and structured specifications that digital health systems use to automate processes. It defines system actors, transactions, computable data dictionaries, and indicators, enabling **interoperability** and seamless guideline updates within software applications.
...
**How it is used by digital health tools:** L4 enables **data collection, processing, and exchange** between different systems. It ensures interoperability with other **SMART Guidelines-compliant** tools, enhancing the ability to integrate and scale digital health solutions effectively.
